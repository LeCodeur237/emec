  ...
  <main>
    ...
    <section class="leaders" id="conseil-executif">
      ...
      <div class="leaders-grid">
        <article class="leader-card reveal" v-for="leader in leaders" :key="leader.role">
          <div class="leader-photo">
            <img v-if="leader.image" :src="leader.image" :alt="leader.name" loading="lazy" />
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      leaders: [
        { initials: 'PR', name: 'Noumessi Anatole', role: 'Président du Conseil Exécutif', title: 'Pasteur', mandate: '2020 - Aujourd\'hui', image: '/images/image-002.png' },
        { initials: 'VPR', name: 'Banguena Sylvain', role: 'Vice-président', title: 'Pasteur', mandate: '2020 - Aujourd\'hui', image: '/images/image-002.png' },
        { initials: 'SG', name: 'Lebongo Ndoman Pierre D.', role: 'Secrétaire Général', title: 'Pasteur', mandate: '2020 - Aujourd\'hui', image: '/images/image-002.png' },
        { initials: 'T', name: 'Ntap Ruben', role: 'Trésorier Général', title: 'Pasteur', mandate: '2020 - Aujourd\'hui', image: '/images/image-002.png' },
        { initials: 'C', name: 'À renseigner', role: 'Conseiller spirituel', title: 'Pasteur', mandate: 'À renseigner', image: '/images/image-002.png' },
        { initials: 'CG', name: 'À renseigner', role: 'Contrôleur de Gestion', title: 'À renseigner', mandate: 'À renseigner', image: '/images/image-002.png' },
      ] as LeaderItem[],
    };
  },
  methods: {
...
.history-copy p:not(.section-eyebrow) {
  max-width: 680px;
  color: var(--text-mid);
  line-height: 1.85;
  margin-bottom: 18px;
...
.identity {
  background:
    linear-gradient(225deg, rgba(201, 168, 76, 0.1), transparent 42%),
    #f0ebe0;
  display: grid;
...
.equipe {
  background:
    linear-gradient(135deg, rgba(201, 168, 76, 0.09), transparent 48%),
    var(--cream);
  padding: 96px 12vw;
}
...
.founder-legacy-list article {
  border: 1px solid rgba(201, 168, 76, 0.26);
  background: rgba(255, 255, 255, 0.52);
  padding: 18px;
}

.founder-legacy-list span {
  display: block;
  font-family: 'Playfair Display', serif;
  font-size: 28px;
...
.churches-header p:not(.section-eyebrow) {
  max-width: 680px;
  color: var(--text-mid);
  line-height: 1.85;
  margin-top: 18px;
